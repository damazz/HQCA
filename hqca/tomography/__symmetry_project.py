...
TODO: Update for generic symmetry projection technique from PRA
"""
...
class SymmetryProjection:
    def __init__(self,
            ...
            weight='default',
            skip_sz=False,
            local_tomography=False,
            verbose=False,
            **kw):
        #print(local_tomography)
        '''
        ...
        if isinstance(op,type(QuantumString())):
            ...
            if len(ops[0][0])==0:
                ...
                dimCe = 2**(len(ops[0][1])) # length constant terms
                sz_done = False
                if skip_sz==False:
                ...
                def bin_to_ph(binary):
                    ...
                    for item in binary:
                        if item=='0':
                            ...
                            ret+='h'
                    return ret
                permC = [bin_to_ph('{0:0{1}b}'.format(i,nC)) for i in range(dimCe)]
                ...
                # ok, so we are making an operator basis based
